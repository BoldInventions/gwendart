...
class ResizableControl extends GwenControlBase
{
  ...
  ResizableControl(GwenControlBase parent) : _resizer = new List<Resizer>(10),  super(parent)
  {
    ClampMovement=false;
    ...
    _onResizeHandler = new ResizableEventHandler(this);
      ...
      _resizer[1].ResizeDir = new Pos(Pos.Bottom.value | Pos.Left.value);
      _resizer[1].Resized.add(_onResizeHandler);;
      _resizer[1]._Target = this;

      _resizer[3] = new Resizer(_resizer[2]);
      _resizer[3].Dock = Pos.Right;
      _resizer[3].ResizeDir = new Pos(Pos.Bottom.value | Pos.Right.value);
